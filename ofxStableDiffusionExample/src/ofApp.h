...
class ofApp : public ofBaseApp {
	public:
		...
		void setupCreativeLoop();
		ofxStableDiffusionRealtimeVideoSettings buildCreativeLoopSettings() const;
		ofxStableDiffusionRealtimeVideoRequest buildCreativeLoopRequest() const;
		bool startCreativeLoop();
		void submitCreativeLoopPrompt();
		void drawCreativeLoopSection();
		...
		ofxStableDiffusionRealtimeVideoSession creativeLoop;
		ofTexture creativeLoopTexture;
		ofxStableDiffusionRealtimeVideoSettings creativeLoopSettings;
		std::string creativeLoopPrompt;
		std::string creativeLoopNegativePrompt;
		std::string creativeLoopStatus;
		bool creativeLoopRunning = false;
		bool creativeLoopUseCurrentPrompts = true;
		bool creativeLoopUseFeedback = true;
		bool creativeLoopRefineOnIdle = true;
		bool creativeLoopDropIfBusy = false;
		bool creativeLoopLockSeed = false;
		int creativeLoopPreviewSteps = 4;
		int creativeLoopRefineSteps = 16;
		float creativeLoopPreviewStrength = 0.68f;
		float creativeLoopRefineStrength = 0.35f;
		float creativeLoopCfgScale = 1.5f;
		float creativeLoopLastLatencyMs = 0.0f;
		int creativeLoopFrameIndex = -1;
		ofxStableDiffusionRealtimeVideoQuality creativeLoopLastQuality =
